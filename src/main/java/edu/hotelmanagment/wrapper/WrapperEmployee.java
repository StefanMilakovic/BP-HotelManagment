...
public class WrapperEmployee
{
    ...
    private static final String SQL_INSERT="insert into employee (First_Name,Last_Name,Email,Phone_Number,Hire_Date,PositionID)values(?,?,?,?,?,?)";
    private static final String SQL_UPDATE="update employee set First_Name=?,Last_Name=?,Email=?,Phone_Number=?,Hire_Date=?,PositionID=? where EmployeeID=?";
    ...
    private static final String SQL_SELECT_RECEPTIONISTS="SELECT * FROM hotel_database.receptionists_view;";
